...
const TAB_GROUPS = [
  ...
  { id:"Database",  label:"Database",  icon:"<svg viewBox='0 0 24 24' width='15' height='15' fill='none' stroke='currentColor' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' style='vertical-align:-2px'><ellipse cx='12' cy='5' rx='8' ry='3'/><path d='M4 5v6c0 1.7 3.6 3 8 3s8-1.3 8-3V5'/><path d='M4 11v6c0 1.7 3.6 3 8 3s8-1.3 8-3v-6'/></svg>", children:["Branches","Departments","Locations","Projects","Assets","Maintenance","Finance","Dispatch","Incidents","Risks","Vehicles"] },
...
function getTabs(){
  ...
  const base = ["Dashboard","Filters","Daily Log","Approvals","Overtime","Travel","Leaves","Work Instructions",
                "HR Report","Daily Log Report","Technical Report","Reports","Finance Report","Analytics","Executive","Requests","Clients","Projects","Assets","Maintenance","Finance","Dispatch","Incidents","Risks","Vehicles","Locations","Departments","Branches","Users","WhatsApp","Email","Share","Profile","This Device","Technical Classifications","Date & Time","Entry Manage","Recycle Bin","My Tasks"];
  if(!base.includes(state.tab)) state.tab = base[0];
  return base;
}
...
function renderTab(){
  ...
  const fn={
    ...
    "Share":renderShare,"Profile":renderProfile,"Date & Time":renderDateTime,"Incidents":renderIncidents, "Risks": renderRisks,"Vehicles":renderVehicles,"Recycle Bin":renderRecycleBin,"Executive":renderExecutive,"Permissions":renderPermissions,
