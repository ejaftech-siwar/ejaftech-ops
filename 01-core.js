...
const TAB_GROUPS = [
  ...
  { id:"Reports",   label:"Reports",   icon:"<svg viewBox='0 0 24 24' width='15' height='15' fill='none' stroke='currentColor' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' style='vertical-align:-2px'><polyline points='3 17 9 11 13 15 21 7'/><polyline points='15 7 21 7 21 13'/></svg>", children:["HR Report","Daily Log Report","Reports","PM Report","Incident Report","Technical Report","Analytics","Executive"] },
...
function getTabs(){
  ...
  const base = ["Dashboard","Daily Log","Overtime","Travel","Leaves","Work Instructions",
                "HR Report","Daily Log Report","Technical Report","Reports","PM Report","Incident Report","Analytics","Executive","Requests","Clients","Projects","Assets","Maintenance","Incidents","Locations","Departments","Branches","Users","WhatsApp","Email","Share","Profile","Technical Classifications","Date & Time","Entry Manage","Recycle Bin","My Tasks"];
  if(!base.includes(state.tab)) state.tab = base[0];
  return base;
}
...
function renderTab(){
  ...
  const fn={
    ...
    "Travel":renderTravel,"Leaves":renderLeaves,"HR Report":renderHRReport,"Technical Report":renderTechReport,"Reports":renderFlexReports,"PM Report":renderPMReportTab,"Incident Report":renderIncidentReportTab,"Analytics":renderAnalytics,
