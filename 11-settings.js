...
window.runFullBackup=async function(){
  try{
    const cols=["daily","overtime","travel","leaves","projects","devices","clients","clientRequests","tasks","pmSchedules","nametagEmployees","locations","branches","departments","workCategories","workTasks","techWorkTypes","techStatuses","techCategories","requestStatuses","projectStatuses","clientPermissions","deviceEditSuggestions","incidents","systemTypes","publicShares","waContacts","emailContacts","settingsDocs","notifications","users"];
